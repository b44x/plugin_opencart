...
class ControllerExtensionPaymentPaylane extends Controller
{
    ...
    public function index()
    {
        ...
        if ($order_info) {
            ...
            $this->data['back_url']                = $this->url->link('extension/payment/paylane/callback', '', true);
            $this->data['amount']                  = $this->toAmount($order_info['total']);
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/paylane.tpl')) {
                $this->template = $this->config->get('config_template') . '/template/extension/payment/paylane.tpl';
            } else {
    ...
    public function callback()
    {
        ...
        if ($order_info && $this->validateReturningHash($request)) {
            ...
            $this->data['back_link']  = $this->url->link('checkout/checkout', '', true);

            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/paylane_error.tpl')) {
                $this->template = $this->config->get('config_template') . '/template/extension/payment/paylane_error.tpl';
            } else {
                $this->template = 'extension/payment/paylane_error.tpl';
            }
